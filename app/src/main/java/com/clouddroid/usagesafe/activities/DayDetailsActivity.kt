...
import com.clouddroid.usagesafe.adapters.DayDetailsAppsAdapter
import com.clouddroid.usagesafe.utils.HourMarkerView
import com.clouddroid.usagesafe.utils.SpinnerAdapter
...
class DayDetailsActivity : BaseActivity() {
    ...
    private fun drawChart(barDataSet: BarDataSet, hoursNames: List<String>) {
        ...
        val marker = HourMarkerView(this, R.layout.chart_marker_view, viewModel.currentMode, hoursNames)
